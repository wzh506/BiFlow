...
notebook_output_path = pathlib.Path('runs_biflow/notebook')
...
layers_per_block = 8
noise_std = 0.07
model = 'biflow'  # specify model type
...
ckpt_file = "runs_biflow/afhq_0109/biflow_afhq_model_8_768_8_8_0.07.pth"
...
if num_classes:
    ...
    fixed_y = None
if model == 'biflow':
    model = biflow.Model(in_channels=channel_size, img_size=img_size, patch_size=patch_size, 
